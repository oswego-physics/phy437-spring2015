...
\begin{displaymath}
\Psi(x)=A\exp(-a(x-\expval{x})^2/2\hbar)\exp(i\expval{p}x/\hbar)
\end{displaymath}
- This is the form of a gaussian, thus the most general minimum uncertainty
  wave packet is a gaussian.
