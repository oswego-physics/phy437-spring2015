...
$$
$$\sigma_{L_x} \sigma_{L_y} \geq \frac{\hbar}{2} \abs{\expval{L_z}}$$
...
- we use the bottom of the $\pm$, and find that
$$
L^2 f_t =
...
- we now use the top of the $\pm$, where we had previously used the bottom, and
  find that
$$
L^2 f_b =
...
\qty[
  ...
  \frac{1}{r^2 \sin^2\theta} \qty( \pdv[2]{\psi}{\theta} )
]
& \\
+ V \psi = E \psi &
\end{align*}
